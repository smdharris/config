...
//Name: quadruped.ma
//Last modified: Thu, Sep 12, 2013 07:53:21 PM
//Codeset: 1252
requires maya "2008";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -35.081632654774005 19.072084598063068 3.6638688635291219 ;
	setAttr ".r" -type "double3" -20.138352760973859 -78.199999999997061 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 38.506552737460062;
	setAttr ".ow" 24.974981546401978;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -0.579628511356864 7.4247627663987119 0.28135788656788829 ;
	setAttr ".hc" -type "string" "viewSet -p %camera";
createNode transform -s -n "top";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.579628511356864 115.16902207479863 0.28135788656791222 ;
...
createNode transform -s -n "side";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 131.98434623320691 7.4247627663987119 0.28135788656791771 ;
...
createNode joint -n "Neck" -p "Chest";
	...
	setAttr ".t" -type "double3" 1.2057937872033071 -0.3190741557487442 0 ;
	setAttr ".ro" 5;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 0 0 -49.338387370248022 ;
	setAttr ".typ" 18;
...
createNode joint -n "Head" -p "Neck";
	...
	setAttr ".r" -type "double3" 0 0 22.42938933411989 ;
	setAttr ".ro" 5;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 0 0 -40.661612629752042 ;
...
createNode joint -n "Hair" -p "Head";
	setAttr ".t" -type "double3" 1.1940176038839925 0 4.683357723479376e-016 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".typ" 18;
...
createNode joint -n "EarEnd" -p "Ear";
	setAttr ".t" -type "double3" 1.9120043140509304 -1.3843093338294921e-015 1.1102230246251563e-015 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".typ" 18;
...
createNode joint -n "Scapula" -p "Chest";
	setAttr ".t" -type "double3" 0 0.94024409094791395 -0.95502152927681572 ;
	setAttr ".ro" 2;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 0 0 93.708206836455361 ;
	setAttr ".dl" yes;
	setAttr ".typ" 18;
	setAttr ".otp" -type "string" "LegAimFront";
	setAttr ".radi" 0.51205178940387641;
createNode joint -n "frontHip" -p "Scapula";
	setAttr ".t" -type "double3" 2.5609724984406954 -4.4408920985006262e-016 -1.2212453270876722e-015 ;
	setAttr ".r" -type "double3" 0 0 -14.04 ;
	setAttr ".ro" 2;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dl" yes;
...
createNode joint -n "frontKnee" -p "frontHip";
	setAttr ".t" -type "double3" 2.6799301464676359 3.3306690738754696e-016 -1.6875389974302379e-014 ;
	setAttr ".r" -type "double3" 0 0 25.76 ;
	setAttr ".ro" 2;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".typ" 18;
...
createNode joint -n "frontAnkle" -p "frontKnee";
	setAttr ".t" -type "double3" 2.4590705413009739 2.1322926916589324e-005 5.5511151231257827e-016 ;
	setAttr ".ro" 3;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 0 0 -15.428206836455374 ;
	setAttr ".dl" yes;
	setAttr ".typ" 18;
...
createNode joint -n "Tail0" -p "Root";
	setAttr ".t" -type "double3" -1.4995579999729969 -0.13321479192219601 1.7296704755040618e-016 ;
	setAttr ".r" -type "double3" 1.2484960879798701e-012 0 0 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
...
createNode joint -n "Tail2" -p "Tail1";
	setAttr ".t" -type "double3" 1 3.5527136788005009e-015 -3.9933994346217903e-016 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dl" yes;
	setAttr ".typ" 18;
...
createNode joint -n "Tail3" -p "Tail2";
	setAttr ".t" -type "double3" 1 -1.4210854715202004e-014 -4.4251470645968298e-016 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".typ" 18;
...
createNode joint -n "backHip" -p "Rump";
	setAttr ".t" -type "double3" 2.8275483175467393 4.4408920985006262e-016 -4.4408920985006262e-016 ;
	setAttr ".r" -type "double3" 0 0 42.458 ;
	setAttr ".ro" 2;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
...
createNode joint -n "backKnee" -p "backHip";
	setAttr ".t" -type "double3" 2.3229548725558775 -3.3306690738754696e-015 1.9984014443252818e-015 ;
	setAttr ".r" -type "double3" 0 0 -39.039 ;
	setAttr ".ro" 2;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
...
createNode joint -n "backAnkle" -p "backKnee";
	setAttr ".t" -type "double3" 2.4338138454722005 0 -1.3322676295501878e-015 ;
	setAttr ".ro" 3;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 0 0 3.2908368077568362 ;
	setAttr ".dl" yes;
	setAttr ".typ" 18;
